...
link="https://github.com/MicrochipTech/cryptoauthlib/archive/refs/tags/v3.7.9.tar.gz"
curl -LO $link
tar -xzf v3.7.9.tar.gz
...
echo "cryptoauthlib-v3.7.9" >> ../esp-cryptoauthlib/cryptoauthlib/version.txt
cd .
rm -rf cryptoauthlib-3.7.9
rm -rf v3.7.9.tar.gz
