 ...
 * For ESP-IDF 6.x+ (mbedTLS 4.x), use CONFIG_MBEDTLS_SECURE_ELEMENT_DRIVER_ENABLED instead. */
...
#warning "ATCA_MBEDTLS_ECDSA is not supported on ESP-IDF 6.x+. Use CONFIG_MBEDTLS_SECURE_ELEMENT_DRIVER_ENABLED instead."
#else
#define ATCA_MBEDTLS
#endif
#endif
